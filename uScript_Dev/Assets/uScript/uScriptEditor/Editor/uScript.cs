...
public class uScript : EditorWindow
{
   ...
   static public string BuildNumber { get { return "0.9.2255"; } }

   static public string BuildName { get { return "Professional (Retail Beta 37)"; } }
   static public string BuildNamePLE { get { return "Personal Learning Edition (Retail Beta 37)"; } }
...
//   }
   ...
   public static string FindNodeDescription(string type, EntityNode node)
   {
      ...
      return "This node appears to have been generated by reflection. It allows access to the " + entityType + " \"" + uScript.GetNodeSignature(node) + "\"."
