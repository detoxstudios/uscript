...
[NodeToolTip("Subtracts two integer variables together and returns the result.")]
[NodeDescription("Subtracts two integer variables together and returns the result.")]
