...
public class uScriptAct_SendCustomEventInt : uScriptLogic
{
   ...
   public void SendCustomEvent([FriendlyName("Event Name")] string EventName, [FriendlyName("Event Value")] int EventValue, [FriendlyName("Event Sender")] GameObject EventSender)
   {
