...
public class uScriptAct_SendCustomEventVector3 : uScriptLogic
{
   ...
   public void SendCustomEvent([FriendlyName("Event Name")] string EventName, [FriendlyName("Event Value")] Vector3 EventValue, [FriendlyName("Event Sender")] GameObject EventSender)
   {
