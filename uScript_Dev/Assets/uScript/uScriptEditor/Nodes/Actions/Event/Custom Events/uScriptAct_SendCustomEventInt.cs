...
[FriendlyName("Send Custom Event (Int)")]
public class uScriptAct_SendCustomEventInt : uScriptLogic
{
   ...
   public void SendCustomEvent([FriendlyName("Event Name")] string EventName, [FriendlyName("Event Value")] int EventValue, [FriendlyName("Broadcast To All"), DefaultValue(false)] bool Broadcast, [FriendlyName("Event Sender"), SocketState(false, false)] GameObject EventSender)
   {
