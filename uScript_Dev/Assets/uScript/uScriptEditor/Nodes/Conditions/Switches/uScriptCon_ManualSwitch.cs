...
[NodeDescription("Manually pick an Output to fire the signal to. Providing a Output To Use number smaller than 1 caps to 1 and larger than 6 caps to 6.")]
...
public class uScriptCon_ManualSwitch : uScriptLogic
{
   ...
   public void In([FriendlyName("Output To Use")] int CurrentOutput)
   {

      // Check bounds on MaxOutputUsed
      if (CurrentOutput < 1) CurrentOutput = 1;
      if (CurrentOutput > 6) CurrentOutput = 6;
