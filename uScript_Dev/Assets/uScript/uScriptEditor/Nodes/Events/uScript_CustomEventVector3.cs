...
[AddComponentMenu("uScript/Event Components/Custom Events/Custom Event (Vector3)")]
...
public class uScript_CustomEventVector3 : uScriptEvent
{
   ...
   {
      if ( OnCustomEventVector3 != null && cEventData.EventData.GetType() == typeof(UnityEngine.Vector3) ) OnCustomEventVector3( this, new CustomEventVector3Args(cEventData.EventName, (Vector3)cEventData.EventData, cEventData.Sender) ); 
   }	
}
