...
[FriendlyName("Receive Signal (Vector2)", "Receives a signal from a Send Signal node  with a Vector2 variable and continues execution.")]
public class uScript_ReceiveSignal_Vector2 : uScriptEvent
{
	...
	public class ReceiveCustomSignalEventArgs : System.EventArgs
	{
		...
		[FriendlyName("Signal Data", "The Vector2 variable that was sent with this signal.")]
		public Vector2 SignalData { get { return m_SignalData; } }
		
		[FriendlyName("Signal", "The name of the signal.")]
		[SocketState(true, false)]
		public string signalName{ get { return m_Signal; } }
		
		public ReceiveCustomSignalEventArgs(GameObject Sender, Vector2 SignalData, string signalName)
		{
			m_Signal = signalName;
	...
	public void OnIncomingSignal(GameObject objectToSignal, GameObject Sender, Vector2 SignalData, string signalName )
	{
