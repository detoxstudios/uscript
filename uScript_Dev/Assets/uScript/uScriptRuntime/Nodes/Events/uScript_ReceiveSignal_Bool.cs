...
[FriendlyName("Receive Signal (Bool)", "Receives a signal from a Send Signal node with a Boolean variable and continues execution.")]
public class uScript_ReceiveSignal_Bool : uScriptEvent
{
	...
	public class ReceiveCustomSignalEventArgs : System.EventArgs
	{
		...
		[FriendlyName("Signal Data", "The Boolean variable that was sent with this signal.")]
		public bool SignalData { get { return m_SignalData; } }
		
		[FriendlyName("Signal", "The name of the signal.")]
		[SocketState(true, false)]
		public string signalName{ get { return m_Signal; } }
		
		public ReceiveCustomSignalEventArgs(GameObject Sender, bool SignalData, string signalName)
		{
			m_Signal = signalName;
	...
	public void OnIncomingSignal(GameObject objectToSignal, GameObject Sender, bool SignalData, string signalName )
	{
