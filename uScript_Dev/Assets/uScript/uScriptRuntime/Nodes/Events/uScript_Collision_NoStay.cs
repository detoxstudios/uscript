// uScript uScript_Collision_NoStay.cs
...
[NodeToolTip("Fires an event signal when Instance receives a collision. Does NOT call when an object stays colliding.")]
[NodeAuthor("Detox Studios LLC", "http://www.detoxstudios.com")]
[NodeHelp("http://docs.uscript.net/#3-Working_With_uScript/3.4-Nodes.htm")]

[FriendlyName("On Collision - No Stay", "Fires an event signal when Instance GameObject receives a collision. Does NOT call when an object stays colliding (this gives a performance boost over the nodes that DO check). The GameObjects involved must have rigidbody components on them to fire this event.")]
public class uScript_Collision_NoStay : uScriptEvent
{
