...
[FriendlyName("2D Raycast From Mouse Cursor", "Cast a 2D ray from the Mouse Cursor into the scene, determines if anything was hit along the way, and fires the associated output link. Used with Unity's 2D Physics system.")]
