...
[FriendlyName("Modify List By Index (Color)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexColor : uScriptLogic
{
	// ================================================================================
	//    Output Sockets
	// ================================================================================
   ...
   public void InsertIntoList(ref Color[] VariableList, int Index, Color[] Target, out int ListCount)
	{
      List<Color> list = new List<Color>(VariableList);
		...
		if (list.Count == 0) {
         foreach (Color tmpVar in Target)
         {
            list.Add(tmpVar);
			}
