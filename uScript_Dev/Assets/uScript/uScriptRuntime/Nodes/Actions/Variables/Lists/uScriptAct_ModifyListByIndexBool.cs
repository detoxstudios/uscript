...
[FriendlyName("Modify List By Index (Bool)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexBool : uScriptLogic
{
	// ================================================================================
	//    Output Sockets
	// ================================================================================
   ...
   public void InsertIntoList(ref bool[] VariableList, int Index, bool[] Target, out int ListCount)
	{
      List<bool> list = new List<bool>(VariableList);
