...
[FriendlyName("Modify List By Index (Int)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexInt : uScriptLogic
{
	// ================================================================================
	//    Output Sockets
	// ================================================================================
   ...
   public void InsertIntoList(ref int[] VariableList, int Index, int[] Target, out int ListCount)
	{
      List<int> list = new List<int>(VariableList);
