...
[FriendlyName("Modify List By Index (RaycastHit2D)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexRaycastHit2D : uScriptLogic
{
    // ================================================================================
    //    Output Sockets
    // ================================================================================
    ...
    public void InsertIntoList(ref RaycastHit2D[] VariableList, int Index, RaycastHit2D[] Target, out int ListCount)
    {
        List<RaycastHit2D> list = new List<RaycastHit2D>(VariableList);
        ...
        if (list.Count == 0)
        {
            foreach (RaycastHit2D tmpVar in Target)
            {
                list.Add(tmpVar);
            }
