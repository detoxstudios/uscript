...
[FriendlyName("Modify List By Index (ContactPoint)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexContactPoint : uScriptLogic
{
    // ================================================================================
    //    Output Sockets
    // ================================================================================
    ...
    public void InsertIntoList(ref ContactPoint[] VariableList, int Index, ContactPoint[] Target, out int ListCount)
    {
        List<ContactPoint> list = new List<ContactPoint>(VariableList);
        ...
        if (list.Count == 0)
        {
            foreach (ContactPoint tmpVar in Target)
            {
                list.Add(tmpVar);
            }
