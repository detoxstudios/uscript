...
[FriendlyName("Modify List By Index (Float)", "Modify a list by specifying a specific slot number (index) in the list.")]
public class uScriptAct_ModifyListByIndexFloat : uScriptLogic
{
	// ================================================================================
	//    Output Sockets
	// ================================================================================
   ...
   public void InsertIntoList(ref float[] VariableList, int Index, float[] Target, out int ListCount)
	{
      List<float> list = new List<float>(VariableList);
		...
		if (list.Count == 0) {
         foreach (float tmpVar in Target)
         {
            list.Add(tmpVar);
			}
