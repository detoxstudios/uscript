...
[FriendlyName("Replace Value In List (Vector3)")]
public class uScriptAct_ReplaceValueInListVector3 : uScriptLogic
{
	public bool Out { get { return true; } }
   
	public void In(
      [FriendlyName("Target List")] Vector3[] TargetList,
      [FriendlyName("Old Value")] Vector3 OldValue,
      [FriendlyName("New Value")]  Vector3 NewValue,
      [FriendlyName("Modified list")] out Vector3[] ModifiedList,
