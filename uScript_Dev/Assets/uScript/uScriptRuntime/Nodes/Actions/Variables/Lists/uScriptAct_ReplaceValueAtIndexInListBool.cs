...
[FriendlyName("Replace Value At Index In List (Bool)", "Replaces a value in the list with the new value at the specified index.")]
public class uScriptAct_ReplaceValueAtIndexInListBool : uScriptLogic
{
