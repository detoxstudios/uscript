...
[NodeToolTip("Sets an int property on a Material.")]
[NodeAuthor("Detox Studios LLC", "http://www.detoxstudios.com")]
[NodeHelp("http://docs.uscript.net/#3-Working_With_uScript/3.4-Nodes.htm")]

[FriendlyName("Material Set Int", "Sets an int property on a Material.")]
public class uScriptAct_MaterialSetInt : uScriptLogic
{
   public bool Out { get { return true; } }

   public void In(
      [FriendlyName("Material", "The Material to set the int on.")]
      Material material,
