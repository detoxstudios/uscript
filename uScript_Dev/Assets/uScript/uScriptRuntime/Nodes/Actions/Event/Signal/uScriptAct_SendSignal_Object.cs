...
[FriendlyName("Send Signal (Object)", "Sends a signal to a GameObject with an Object variable.")]
public class uScriptAct_SendSignal_Object: uScriptLogic
{
	public bool Out { get { return true; } }
	
	public delegate void uScriptSendSignalDelegate(GameObject objectToSignal, GameObject SignalSender, Object SIgnalValue, string signalName);
	...
	public void SendCustomSignal(
		...
		[FriendlyName("Signal Data", "The Object value to pass in the signal.")]
		Object SignalData
		)
	{
		...
		uScript_ReceiveSignal_Object receiver = objectToSignal.GetComponent<uScript_ReceiveSignal_Object>();
