...
[FriendlyName("Send Signal (Vector3)", "Sends a signal to a GameObject with a Vector3 variable.")]
public class uScriptAct_SendSignal_Vector3: uScriptLogic
{
	public bool Out { get { return true; } }
	
	public delegate void uScriptSendSignalDelegate(GameObject objectToSignal, GameObject SignalSender, Vector3 SignalValue, string signalName);
	...
	public void SendCustomSignal(
		...
		[FriendlyName("Signal Data", "The Vector3 value to pass in the signal.")]
		Vector3 SignalData
		)
	{
		...
		uScript_ReceiveSignal_Vector3 receiver = objectToSignal.GetComponent<uScript_ReceiveSignal_Vector3>();
