...
public class uScriptAct_FilterVector : uScriptLogic
{
   ...
   public void Reset(object Target, [FriendlyName("Filter Constant"), DefaultValue(0.1f)]float FilterConstant, out Vector3 Value3, out Vector4 Value4)
   {
   ...
   public void Filter(object Target, [FriendlyName("Filter Constant"), DefaultValue(0.1f)]float FilterConstant, out Vector3 Value3, out Vector4 Value4)
   {
