...
// Desc: Generates an MD5 hash string from a key.
...
[NodeDescription("Generates an MD5 hash string from a key.\n\nKey: The string to be used to generate the hash from.\nMD5 Hash (out): The MD5 Hash generated by the Key.")]
[NodeAuthor("Detox Studios LLC", "http://www.detoxstudios.com")]
[NodeHelp("http://www.uscript.net/docs/index.php?title=Node_Reference_Guide")]

[FriendlyName("Generate MD5 Hash")]
public class uScriptAct_GenerateMD5Hash : uScriptLogic
{
   public bool Out { get { return true; } }

   public void In([FriendlyName("Key")] string Key, [FriendlyName("MD5 Hash")] out string Hash)
   {
      if (Key != "")
      {
