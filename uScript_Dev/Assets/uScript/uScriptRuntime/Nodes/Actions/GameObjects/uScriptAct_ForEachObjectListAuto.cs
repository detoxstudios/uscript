...
[FriendlyName("For Each GameObject In List (Auto)", "Iterate through each GameObject in a GameObject list (node will automatically iterate through the list).")]
public class uScriptAct_ForEachObjectListAuto : uScriptLogic
{
   ...
   public void In(
      [FriendlyName("GameObject List", "The list of GameObjects to iterate over.")]
