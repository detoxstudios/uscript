...
"AS Badge Move",
   ...
   internal static void Init()
   {
      ...
      EditorWindow.GetWindow<TestEditor>("Test Editor");
   }
   ...
   internal void OnGUI()
   {
      ...
      GUILayout.Label(string.Format("IconContent(KNOWN) : {0} styles", knownNamedTextures.Count), EditorStyles.boldLabel);
   ...
   private static GUIContent IconContent(string name)
   {
      ...
      MethodInfo mi = typeof(EditorGUIUtility).GetMethod(
   ...
   {
      FieldInfo fi = typeof(EditorGUIUtility).GetField(
