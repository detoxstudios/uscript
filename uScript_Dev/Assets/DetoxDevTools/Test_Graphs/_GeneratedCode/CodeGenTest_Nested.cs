      ...
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("f2b843e0-e44e-4032-82f3-328a64317d01", "Log", Relay_In_0)) return; 
         {
            ...
            }
            {
               ...
               int index = 0;
               properties = external_2;
               if ( logic_uScriptAct_Log_Target_0.Length != index + properties.Length)
               {
                  System.Array.Resize(ref logic_uScriptAct_Log_Target_0, index + properties.Length);
               }
               System.Array.Copy(properties, 0, logic_uScriptAct_Log_Target_0, index, properties.Length);
