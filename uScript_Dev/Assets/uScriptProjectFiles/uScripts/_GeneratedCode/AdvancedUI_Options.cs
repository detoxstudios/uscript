...
[System.Serializable]
[FriendlyName("", "")]
public class AdvancedUI_Options : uScriptLogic
{
   ...
   System.Boolean local_Music_On_System_Boolean = (bool) true;
   System.Boolean local_SFX_On_System_Boolean = (bool) true;
   ...
   UnityEngine.Texture2D logic_uScriptAct_GUIBeginGroup_Texture_1 = null;
   ...
   System.String logic_uScriptAct_GUIBox_Text_5 = "Options";
   UnityEngine.Rect logic_uScriptAct_GUIBox_Position_5 = new Rect( (float)0, (float)0, (float)600, (float)400 );
   UnityEngine.Texture2D logic_uScriptAct_GUIBox_Texture_5 = null;
   ...
   System.String logic_uScriptCon_CompareString_B_18 = "Options";
   ...
   UnityEngine.GameObject logic_uScriptAct_SendCustomEventString_EventSender_31 = null;
   ...
   //pointer to script instanced logic node
   uScriptAct_GUIToggle logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_34 = new uScriptAct_GUIToggle( );
   System.Boolean logic_uScriptAct_GUIToggle_Value_34 = (bool) false;
   System.String logic_uScriptAct_GUIToggle_Text_34 = "SFX On";
   UnityEngine.Rect logic_uScriptAct_GUIToggle_Position_34 = new Rect( (float)40, (float)40, (float)520, (float)20 );
   UnityEngine.Texture2D logic_uScriptAct_GUIToggle_Texture_34 = null;
   System.String logic_uScriptAct_GUIToggle_ToolTip_34 = "";
   System.String logic_uScriptAct_GUIToggle_guiStyle_34 = "";
   bool logic_uScriptAct_GUIToggle_Out_34 = true;
   bool logic_uScriptAct_GUIToggle_Changed_34 = true;
   //pointer to script instanced logic node
   uScriptAct_GUIToggle logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_36 = new uScriptAct_GUIToggle( );
   System.Boolean logic_uScriptAct_GUIToggle_Value_36 = (bool) false;
   System.String logic_uScriptAct_GUIToggle_Text_36 = "Music On";
   UnityEngine.Rect logic_uScriptAct_GUIToggle_Position_36 = new Rect( (float)40, (float)80, (float)520, (float)20 );
   UnityEngine.Texture2D logic_uScriptAct_GUIToggle_Texture_36 = null;
   System.String logic_uScriptAct_GUIToggle_ToolTip_36 = "";
   System.String logic_uScriptAct_GUIToggle_guiStyle_36 = "";
   bool logic_uScriptAct_GUIToggle_Out_36 = true;
   bool logic_uScriptAct_GUIToggle_Changed_36 = true;
   ...
   public override void SetParent(GameObject g)
   {
      ...
      logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_34.SetParent(g);
      logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_36.SetParent(g);
   }
   public void Awake()
   {
   ...
   void Relay_OnGui_0()
   {
      if (true == CheckDebugBreak("147aaa7d-d122-40e8-abe2-80f201356edf", "GUI Events", Relay_OnGui_0)) return; 
      Relay_In_1();
   }
   ...
   void Relay_In_1()
   {
      ...
      {
         if (true == CheckDebugBreak("5264832f-c586-486a-96c3-3a4bbd9bfc20", "GUI Begin Group", Relay_In_1)) return; 
         {
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Begin Group.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   
   void Relay_uScriptStart_2()
   {
      if (true == CheckDebugBreak("142bb7d2-9a66-46e4-b88b-305ea355566c", "uScript Events", Relay_uScriptStart_2)) return; 
      Relay_In_3();
   }
   
   void Relay_uScriptLateStart_2()
   {
      if (true == CheckDebugBreak("142bb7d2-9a66-46e4-b88b-305ea355566c", "uScript Events", Relay_uScriptLateStart_2)) return; 
   }
   ...
   void Relay_In_3()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("34c65f62-1988-4081-b2b4-86bf2f901d6d", "Create Relative Rect (Screen)", Relay_In_3)) return; 
         {
            {
            }
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Create Relative Rect (Screen).  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_5()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("e75e3898-72da-4170-8679-480a80a5c381", "GUI Box", Relay_In_5)) return; 
         {
            {
            }
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Box.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_OnButtonDown_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3b561381-83f6-4e7e-af43-79a13065e583", "GUI Button", Relay_OnButtonDown_6)) return; 
      }
      else
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Button.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_OnButtonHeld_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3b561381-83f6-4e7e-af43-79a13065e583", "GUI Button", Relay_OnButtonHeld_6)) return; 
      }
      else
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Button.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
   ...
   void Relay_OnButtonUp_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3b561381-83f6-4e7e-af43-79a13065e583", "GUI Button", Relay_OnButtonUp_6)) return; 
      }
      else
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Button.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
   ...
   void Relay_OnButtonClicked_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3b561381-83f6-4e7e-af43-79a13065e583", "GUI Button", Relay_OnButtonClicked_6)) return; 
   ...
   void Relay_In_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3b561381-83f6-4e7e-af43-79a13065e583", "GUI Button", Relay_In_6)) return; 
         {
            {
   ...
   void Relay_In_8()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("52d5cf8c-1389-4ebf-b017-600a8334d984", "GUI End Group", Relay_In_8)) return; 
         {
         }
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI End Group.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   
   void Relay_OnUpdate_11()
   {
      if (true == CheckDebugBreak("6f411169-b787-4ba5-8dff-9c129355d01b", "Global Update", Relay_OnUpdate_11)) return; 
      Relay_Filter_12();
   }
   
   void Relay_OnLateUpdate_11()
   {
      if (true == CheckDebugBreak("6f411169-b787-4ba5-8dff-9c129355d01b", "Global Update", Relay_OnLateUpdate_11)) return; 
   }
   
   void Relay_OnFixedUpdate_11()
   {
      if (true == CheckDebugBreak("6f411169-b787-4ba5-8dff-9c129355d01b", "Global Update", Relay_OnFixedUpdate_11)) return; 
   }
   ...
   void Relay_Reset_12()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("07cb7dc7-127e-429c-8b73-a68849028c77", "Filter Rect", Relay_Reset_12)) return; 
         {
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Filter Rect.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_Filter_12()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("07cb7dc7-127e-429c-8b73-a68849028c77", "Filter Rect", Relay_Filter_12)) return; 
         {
            {
               logic_uScriptAct_FilterRect_Target_12 = local_Target_Rect_UnityEngine_Rect;
   ...
   {
      if (true == CheckDebugBreak("1d6d4a07-bce2-4eea-a953-a8478cc30661", "Custom Event (String)", Relay_OnCustomEventString_15)) return; 
   ...
   void Relay_In_18()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("759827d3-d770-4b3d-bc8c-57687f83fafc", "Compare String", Relay_In_18)) return; 
         {
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Compare String.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_19()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("aac8d650-712b-4248-b513-14bcd5c7ce29", "Compare String", Relay_In_19)) return; 
         {
            {
   ...
   void Relay_In_20()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("c8f331db-f880-48f3-92d0-08aced7c34c8", "Create Relative Rect (Screen)", Relay_In_20)) return; 
         {
            {
            }
            {
   ...
   void Relay_In_23()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("ab90415b-4dc2-4605-8dc7-a127b9a43e71", "Get Components (Rect)", Relay_In_23)) return; 
         {
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Get Components (Rect).  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_25()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("d460684c-6acd-4352-aafd-b66804f7d228", "Set Components (Rect)", Relay_In_25)) return; 
         {
            {
            }
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Set Components (Rect).  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_28()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("b2adeacb-fa4c-40f3-a809-a77876ea0087", "Get Components (Rect)", Relay_In_28)) return; 
         {
            {
   ...
   void Relay_SendCustomEvent_31()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("4c0c2678-3ddb-435c-9fcf-f987c98bc601", "Send Custom Event (String)", Relay_SendCustomEvent_31)) return; 
         {
            {
            }
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at Send Custom Event (String).  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_32()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("93a7cb18-5a50-4ce9-b5a4-fce1e9c966f8", "Set Components (Rect)", Relay_In_32)) return; 
         {
            {
            }
            {
   ...
   void Relay_In_34()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("18deede5-4ef7-4912-a0d2-33b938d64ecc", "GUI Toggle", Relay_In_34)) return; 
         {
            {
               logic_uScriptAct_GUIToggle_Value_34 = local_SFX_On_System_Boolean;
         ...
         logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_34.In(ref logic_uScriptAct_GUIToggle_Value_34, logic_uScriptAct_GUIToggle_Text_34, logic_uScriptAct_GUIToggle_Position_34, logic_uScriptAct_GUIToggle_Texture_34, logic_uScriptAct_GUIToggle_ToolTip_34, logic_uScriptAct_GUIToggle_guiStyle_34);
         local_SFX_On_System_Boolean = logic_uScriptAct_GUIToggle_Value_34;
         
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_34.Out;
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AdvancedUI_Options.uscript at GUI Toggle.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_36()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("3965fb59-4fb5-4bb2-a7f2-9b1bf47e12e6", "GUI Toggle", Relay_In_36)) return; 
         {
            {
               logic_uScriptAct_GUIToggle_Value_36 = local_Music_On_System_Boolean;
         ...
         logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_36.In(ref logic_uScriptAct_GUIToggle_Value_36, logic_uScriptAct_GUIToggle_Text_36, logic_uScriptAct_GUIToggle_Position_36, logic_uScriptAct_GUIToggle_Texture_36, logic_uScriptAct_GUIToggle_ToolTip_36, logic_uScriptAct_GUIToggle_guiStyle_36);
         local_Music_On_System_Boolean = logic_uScriptAct_GUIToggle_Value_36;
         
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_36.Out;
   ...
   {
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:7", local_7_UnityEngine_Rect);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:9", local_9_System_String);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "ff4ec241-4417-4230-b8ae-68c41d09311f", local_9_System_String);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:Filtered Rect", local_Filtered_Rect_UnityEngine_Rect);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:16", local_16_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:17", local_17_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:22", local_22_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:24", local_24_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:26", local_26_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:27", local_27_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:Target Rect", local_Target_Rect_UnityEngine_Rect);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:30", local_30_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:33", local_33_System_Single);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:SFX On", local_SFX_On_System_Boolean);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "d4acda6b-d565-4059-a3bf-6f7b34e1e2f6", local_SFX_On_System_Boolean);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AdvancedUI_Options.uscript:Music On", local_Music_On_System_Boolean);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "86a4d755-468b-4fd8-a4e7-72d5d2b0f71d", local_Music_On_System_Boolean);
   }
