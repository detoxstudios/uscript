...
public class SquibEffect_Gameplay : uScriptLogic
{
   ...
   UnityEngine.Camera local_32_UnityEngine_Camera = default(UnityEngine.Camera);
   ...
   UnityEngine.Texture2D local_Crosshair_Texture2D_UnityEngine_Texture2D = default(UnityEngine.Texture2D);
   ...
   UnityEngine.Camera logic_uScriptAct_RaycastFromCamera_Camera_5 = default(UnityEngine.Camera);
   ...
   UnityEngine.Texture2D logic_uScriptAct_GUITexture_Texture_23 = default(UnityEngine.Texture2D);
   ...
   UnityEngine.GameObject logic_uScriptAct_SendCustomEventInt_EventSender_31 = default(UnityEngine.GameObject);
   ...
   UnityEngine.GameObject logic_uScriptAct_SendCustomEventInt_EventSender_38 = default(UnityEngine.GameObject);
   ...
   UnityEngine.GameObject logic_uScriptAct_AddForce_Target_49 = default(UnityEngine.GameObject);
   ...
   UnityEngine.GameObject logic_uScriptAct_GetPositionAndRotation_Target_56 = default(UnityEngine.GameObject);
   ...
   UnityEngine.GameObject event_UnityEngine_GameObject_Sender_54 = default(UnityEngine.GameObject);
   ...
   UnityEngine.GameObject event_UnityEngine_GameObject_Instance_65 = default(UnityEngine.GameObject);
   ...
   void Relay_In_27()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("ebe0881f-4ab9-45f3-b19a-9af4e7034095", "Concatenate", Relay_In_27)) return; 
         {
            {
               int index = 0;
               if ( logic_uScriptAct_Concatenate_A_27.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_Concatenate_A_27, index + 1);
               }
               logic_uScriptAct_Concatenate_A_27[ index++ ] = local_33_System_String;
               
            }
            {
               int index = 0;
               if ( logic_uScriptAct_Concatenate_B_27.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_Concatenate_B_27, index + 1);
               }
               logic_uScriptAct_Concatenate_B_27[ index++ ] = local_Grenades_On_Hand_System_Int32;
         ...
         {
            {
               ...
               if ( logic_uScriptAct_Destroy_Target_68.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_Destroy_Target_68, index + 1);
               }
               logic_uScriptAct_Destroy_Target_68[ index++ ] = local_62_UnityEngine_GameObject;
         ...
         {
            {
               ...
               if ( logic_uScriptAct_Destroy_Target_84.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_Destroy_Target_84, index + 1);
               }
               logic_uScriptAct_Destroy_Target_84[ index++ ] = local_85_UnityEngine_GameObject;
