...
public class SimpleLogic_Graph : uScriptLogic
{
   ...
   UnityEngine.GameObject logic_uScriptAct_SwitchCameras_FromCamera_5 = default(UnityEngine.GameObject);
   UnityEngine.GameObject logic_uScriptAct_SwitchCameras_Target_5 = default(UnityEngine.GameObject);
   ...
   UnityEngine.Rigidbody event_UnityEngine_GameObject_RigidBody_2 = default(UnityEngine.Rigidbody);
   UnityEngine.Collider event_UnityEngine_GameObject_Collider_2 = default(UnityEngine.Collider);
   UnityEngine.Transform event_UnityEngine_GameObject_Transform_2 = default(UnityEngine.Transform);
   UnityEngine.ContactPoint[] event_UnityEngine_GameObject_Contacts_2 = new UnityEngine.ContactPoint[ 0 ];
   UnityEngine.GameObject event_UnityEngine_GameObject_GameObject_2 = default(UnityEngine.GameObject);
   ...
   void Relay_In_0()
   {
      ...
      {
         if (true == CheckDebugBreak("072e5750-c5e9-4f3c-9855-d53d39344a86", "Switch_Cameras", Relay_In_0)) return; 
         {
            {
               {
                  //if our game object reference was changed then we need to reset event listeners
   ...
   {
      if (true == CheckDebugBreak("5362511a-20a4-4005-ad4b-0e7885ef4695", "On_Collision", Relay_OnEnterCollision_2)) return; 
      Relay_ShowLabel_10();
      Relay_In_7();
   }
   ...
   {
      if (true == CheckDebugBreak("5362511a-20a4-4005-ad4b-0e7885ef4695", "On_Collision", Relay_OnExitCollision_2)) return; 
   }
   
   void Relay_WhileInsideCollision_2()
   {
      if (true == CheckDebugBreak("5362511a-20a4-4005-ad4b-0e7885ef4695", "On_Collision", Relay_WhileInsideCollision_2)) return; 
   }
   ...
   void Relay_In_3()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("c9a4c85f-478b-4474-94e8-76dabc44681f", "Input_Events_Filter", Relay_In_3)) return; 
         {
            {
            }
         }
   ...
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnEnter_4)) return; 
   }
   
   void Relay_OnOver_4()
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnOver_4)) return; 
      Relay_ShowLabel_8();
   }
   
   void Relay_OnExit_4()
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnExit_4)) return; 
      Relay_HideLabel_8();
   }
   
   void Relay_OnDown_4()
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnDown_4)) return; 
   }
   
   void Relay_OnUp_4()
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnUp_4)) return; 
   }
   
   void Relay_OnDrag_4()
   {
      if (true == CheckDebugBreak("e81a5b7b-1435-4c4a-837a-4c5d0dee717a", "Mouse_Cursor_Events", Relay_OnDrag_4)) return; 
   }
   ...
   void Relay_In_5()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("80fb89e5-e340-49c8-b1f9-33310c220370", "Switch_Cameras", Relay_In_5)) return; 
         {
            {
               {
                  //if our game object reference was changed then we need to reset event listeners
   ...
   {
      if (true == CheckDebugBreak("6a046e38-655f-49eb-9bc8-a69830feddd1", "uScript_Events", Relay_uScriptStart_6)) return; 
      Relay_In_9();
      Relay_ShowLabel_11();
   }
   ...
   {
      if (true == CheckDebugBreak("6a046e38-655f-49eb-9bc8-a69830feddd1", "uScript_Events", Relay_uScriptLateStart_6)) return; 
   }
   ...
   void Relay_In_7()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("54cac139-791c-4225-80b8-3e2c681993a5", "Set_Color", Relay_In_7)) return; 
         {
            {
            }
            {
   ...
   void Relay_ShowLabel_8()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("d38a7f9a-796d-41df-b676-c9605310ff28", "Print_Text", Relay_ShowLabel_8)) return; 
         {
            {
            }
            {
   ...
   void Relay_HideLabel_8()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("d38a7f9a-796d-41df-b676-c9605310ff28", "Print_Text", Relay_HideLabel_8)) return; 
         {
            {
            }
            {
   ...
   void Relay_ShowLabel_10()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("41bd28dd-9789-4f5f-a29d-cb156e159362", "Print_Text", Relay_ShowLabel_10)) return; 
         {
            {
            }
            {
   ...
   void Relay_HideLabel_10()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("41bd28dd-9789-4f5f-a29d-cb156e159362", "Print_Text", Relay_HideLabel_10)) return; 
         {
            {
            }
            {
   ...
   void Relay_ShowLabel_11()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("9020d966-4b89-4e47-b346-70862f90b4c1", "Print_Text", Relay_ShowLabel_11)) return; 
         {
            {
            }
            {
   ...
   void Relay_HideLabel_11()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("9020d966-4b89-4e47-b346-70862f90b4c1", "Print_Text", Relay_HideLabel_11)) return; 
         {
            {
            }
            {
   ...
   {
      if (true == CheckDebugBreak("13138bbc-a045-47f3-a720-2ecdcd5fd26e", "Input_Events", Relay_KeyEvent_15)) return; 
      Relay_In_3();
   }
