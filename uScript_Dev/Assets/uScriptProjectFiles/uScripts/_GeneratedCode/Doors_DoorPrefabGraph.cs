...
public class Doors_DoorPrefabGraph : uScriptLogic
{
   ...
   UnityEngine.GameObject logic_uScriptAct_GetChildrenByName_Target_19 = default(UnityEngine.GameObject);
   System.String logic_uScriptAct_GetChildrenByName_Name_19 = "";
   ...
   void SyncUnityHooks( )
   {
      ...
      if ( null == owner_Connection_21 || false == m_RegisteredForEvents )
      {
         ...
         {
            {
               uScript_Trigger component = owner_Connection_21.GetComponent<uScript_Trigger>();
               if ( null == component )
               {
                  component = owner_Connection_21.AddComponent<uScript_Trigger>();
               }
               if ( null != component )
               {
   ...
   void Relay_Finished_0()
   {
      ...
      {
         if (true == CheckDebugBreak("02c0120c-567a-4437-b5ab-2b496bce8f51", "Play_Animation", Relay_Finished_0)) return; 
         Relay_In_11();
      }
      else
      {
   ...
   void Relay_In_0()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("02c0120c-567a-4437-b5ab-2b496bce8f51", "Play_Animation", Relay_In_0)) return; 
         {
            {
               int index = 0;
               {
               ...
               logic_uScriptAct_PlayAnimation_Target_0[ index++ ] = local_Door_L_UnityEngine_GameObject;
   ...
   void Relay_True_2()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("47854d78-4fcc-4b8c-9896-a0ee58adbed9", "Set_Bool", Relay_True_2)) return; 
         {
            {
            }
         }
   ...
   void Relay_False_2()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("47854d78-4fcc-4b8c-9896-a0ee58adbed9", "Set_Bool", Relay_False_2)) return; 
         {
            {
            }
         }
   ...
   void Relay_True_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("01c319bc-1475-4292-8793-50f148b79519", "Set_Bool", Relay_True_4)) return; 
         {
            {
            }
         }
   ...
   void Relay_False_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("01c319bc-1475-4292-8793-50f148b79519", "Set_Bool", Relay_False_4)) return; 
         {
            {
            }
         }
   ...
   void Relay_Finished_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("931aa7ee-5f34-41a6-8b49-67961dc96934", "Play_Animation", Relay_Finished_6)) return; 
         Relay_False_2();
      }
      else
      {
   ...
   void Relay_In_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("931aa7ee-5f34-41a6-8b49-67961dc96934", "Play_Animation", Relay_In_6)) return; 
         {
            {
               int index = 0;
               {
               ...
               if ( logic_uScriptAct_PlayAnimation_Target_6.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_PlayAnimation_Target_6, index + 1);
               }
               logic_uScriptAct_PlayAnimation_Target_6[ index++ ] = local_Door_L_UnityEngine_GameObject;
   ...
   void Relay_In_7()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("8d301f1c-5933-4f31-91ec-e94500f4a872", "Compare_Bool", Relay_In_7)) return; 
         {
            {
   ...
   void Relay_In_8()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("e436eefa-95f7-4577-98e7-da05ee315692", "Get_Children_By_Name", Relay_In_8)) return; 
         {
            {
   ...
   void Relay_Finished_9()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("60d982a5-e90f-412f-9aa1-db3dcc46305f", "Play_Animation", Relay_Finished_9)) return; 
         Relay_In_17();
      }
      else
      {
   ...
   void Relay_In_9()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("60d982a5-e90f-412f-9aa1-db3dcc46305f", "Play_Animation", Relay_In_9)) return; 
         {
            {
               int index = 0;
               {
   ...
   void Relay_Finished_12()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("0003d525-2aaf-4de1-9d26-e53f02b5ac5b", "Play_Animation", Relay_Finished_12)) return; 
         Relay_False_2();
      }
      else
      {
   ...
   void Relay_In_12()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("0003d525-2aaf-4de1-9d26-e53f02b5ac5b", "Play_Animation", Relay_In_12)) return; 
         {
            {
               int index = 0;
               {
               ...
               if ( logic_uScriptAct_PlayAnimation_Target_12.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_PlayAnimation_Target_12, index + 1);
               }
               logic_uScriptAct_PlayAnimation_Target_12[ index++ ] = local_Door_R_UnityEngine_GameObject;
   ...
   void Relay_Stop_17()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("9a88b379-7143-42c4-9996-fe51d191e3af", "Delay", Relay_Stop_17)) return; 
         {
            {
            }
            {
   ...
   void Relay_In_19()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("e80689cc-0d7f-4436-bed7-80513018971f", "Get_Children_By_Name", Relay_In_19)) return; 
         {
            {
               logic_uScriptAct_GetChildrenByName_Target_19 = owner_Connection_14;
               
            }
            {
               logic_uScriptAct_GetChildrenByName_Name_19 = local_1_System_String;
         ...
         local_Door_L_UnityEngine_GameObject = logic_uScriptAct_GetChildrenByName_FirstChild_19;
         {
            //if our game object reference was changed then we need to reset event listeners
            if ( local_Door_L_UnityEngine_GameObject_previous != local_Door_L_UnityEngine_GameObject || false == m_RegisteredForEvents )
            {
   ...
   {
      if (true == CheckDebugBreak("f61f197e-2d7a-42ef-9d61-db3c5d5987d0", "Trigger_Event", Relay_OnEnterTrigger_22)) return; 
      Relay_In_7();
   }
   
   void Relay_OnExitTrigger_22()
   {
      if (true == CheckDebugBreak("f61f197e-2d7a-42ef-9d61-db3c5d5987d0", "Trigger_Event", Relay_OnExitTrigger_22)) return; 
   }
   
   void Relay_WhileInsideTrigger_22()
   {
      if (true == CheckDebugBreak("f61f197e-2d7a-42ef-9d61-db3c5d5987d0", "Trigger_Event", Relay_WhileInsideTrigger_22)) return; 
   }
