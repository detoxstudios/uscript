...
[System.Serializable]
[FriendlyName("", "")]
public class WebTextureExample : uScriptLogic
{
   ...
   void Relay_In_1()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript WebTextureExample.uscript at GUI Label.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_OnButtonDown_2()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript WebTextureExample.uscript at GUI Button.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_3()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript WebTextureExample.uscript at Set String.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_4()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript WebTextureExample.uscript at GUI Text Field.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_8()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript WebTextureExample.uscript at Web Texture.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   {
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:WWW Texture", local_WWW_Texture_UnityEngine_Texture2D);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:WWW Error", local_WWW_Error_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:URL", local_URL_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:wwwStatus", local_wwwStatus_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:21", local_21_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "WebTextureExample.uscript:22", local_22_System_String);
