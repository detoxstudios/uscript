...
public class FireBot_FireLogic : uScriptLogic
{
   ...
   {
      if (true == CheckDebugBreak("ff3d3764-fd09-4531-8849-de61baaa8a34", "Trigger_Event", Relay_OnEnterTrigger_31)) return; 
   ...
   {
      if (true == CheckDebugBreak("ff3d3764-fd09-4531-8849-de61baaa8a34", "Trigger_Event", Relay_OnExitTrigger_31)) return; 
      local_2_UnityEngine_GameObject = event_UnityEngine_GameObject_GameObject_31;
      {
         //if our game object reference was changed then we need to reset event listeners
         if ( local_2_UnityEngine_GameObject_previous != local_2_UnityEngine_GameObject || false == m_RegisteredForEvents )
   ...
   {
      if (true == CheckDebugBreak("ff3d3764-fd09-4531-8849-de61baaa8a34", "Trigger_Event", Relay_WhileInsideTrigger_31)) return; 
      local_2_UnityEngine_GameObject = event_UnityEngine_GameObject_GameObject_31;
      {
         //if our game object reference was changed then we need to reset event listeners
         if ( local_2_UnityEngine_GameObject_previous != local_2_UnityEngine_GameObject || false == m_RegisteredForEvents )
