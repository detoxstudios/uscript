...
public class AdvancedUI_Credits : uScriptLogic
{
   ...
   UnityEngine.Texture logic_uScriptAct_GUILabel_Texture_34 = null;
   ...
   void Relay_In_34()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("65037f3f-9c9f-4401-bb63-895893008ad6", "GUI Label", Relay_In_34)) return; 
         {
            {
            }
            {
