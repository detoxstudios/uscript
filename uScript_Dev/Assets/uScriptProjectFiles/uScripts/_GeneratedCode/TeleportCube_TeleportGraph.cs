...
public class TeleportCube_TeleportGraph : uScriptLogic
{
   ...
   uScriptAct_Teleport logic_uScriptAct_Teleport_uScriptAct_Teleport_1 = new uScriptAct_Teleport( );
   UnityEngine.GameObject[] logic_uScriptAct_Teleport_Target_1 = new UnityEngine.GameObject[] {};
   UnityEngine.GameObject logic_uScriptAct_Teleport_Destination_1 = null;
   System.Boolean logic_uScriptAct_Teleport_UpdateRotation_1 = (bool) false;
   bool logic_uScriptAct_Teleport_Out_1 = true;
   //pointer to script instanced logic node
   ...
   System.Single logic_uScriptAct_MoveToLocation_totalTime_4 = (float) 4;
   bool logic_uScriptAct_MoveToLocation_Out_4 = true;
   bool logic_uScriptAct_MoveToLocation_Cancelled_4 = true;
   //pointer to script instanced logic node
   uScriptAct_GetPositionAndRotation logic_uScriptAct_GetPositionAndRotation_uScriptAct_GetPositionAndRotation_5 = new uScriptAct_GetPositionAndRotation( );
   UnityEngine.GameObject logic_uScriptAct_GetPositionAndRotation_Target_5 = null;
   System.Boolean logic_uScriptAct_GetPositionAndRotation_GetLocal_5 = (bool) false;
   UnityEngine.Vector3 logic_uScriptAct_GetPositionAndRotation_Position_5;
   UnityEngine.Quaternion logic_uScriptAct_GetPositionAndRotation_Rotation_5;
   UnityEngine.Vector3 logic_uScriptAct_GetPositionAndRotation_EulerAngles_5;
   UnityEngine.Vector3 logic_uScriptAct_GetPositionAndRotation_Forward_5;
   UnityEngine.Vector3 logic_uScriptAct_GetPositionAndRotation_Up_5;
   UnityEngine.Vector3 logic_uScriptAct_GetPositionAndRotation_Right_5;
   bool logic_uScriptAct_GetPositionAndRotation_Out_5 = true;
   ...
   void SyncUnityHooks( )
   {
      ...
      {
         local_2_UnityEngine_GameObject = GameObject.Find( "Cube" ) as UnityEngine.GameObject;
      }
      ...
      {
         local_3_UnityEngine_GameObject = GameObject.Find( "Teleport_Point" ) as UnityEngine.GameObject;
      }
      //if our game object reference was changed then we need to reset event listeners
      ...
      {
         local_7_UnityEngine_GameObject = GameObject.Find( "Teleport_Trigger" ) as UnityEngine.GameObject;
      }
      //if our game object reference was changed then we need to reset event listeners
      ...
      {
         local_9_UnityEngine_GameObject = GameObject.Find( "Cube" ) as UnityEngine.GameObject;
      }
      //if our game object reference was changed then we need to reset event listeners
   ...
   void SyncEventListeners( )
   {
      ...
      {
         event_UnityEngine_GameObject_Instance_0 = GameObject.Find( "Teleport_Trigger" ) as UnityEngine.GameObject;
         if ( null != event_UnityEngine_GameObject_Instance_0 )
         {
            {
               uScript_Triggers component = event_UnityEngine_GameObject_Instance_0.GetComponent<uScript_Triggers>();
               if ( null == component )
               {
                  component = event_UnityEngine_GameObject_Instance_0.AddComponent<uScript_Triggers>();
               }
               if ( null != component )
               {
   ...
   public override void SetParent(GameObject g)
   {
      ...
      logic_uScriptAct_Teleport_uScriptAct_Teleport_1.SetParent(g);
      logic_uScriptAct_MoveToLocation_uScriptAct_MoveToLocation_4.SetParent(g);
      logic_uScriptAct_GetPositionAndRotation_uScriptAct_GetPositionAndRotation_5.SetParent(g);
   }
   public void Awake()
   {
   ...
   {
      if (true == CheckDebugBreak("b0aa0ab4-b541-4b7b-8964-a20a0c4b31de", "Trigger Events", Relay_OnEnterTrigger_0)) return; 
      Relay_In_1();
   }
   
   void Relay_OnExitTrigger_0()
   {
      if (true == CheckDebugBreak("b0aa0ab4-b541-4b7b-8964-a20a0c4b31de", "Trigger Events", Relay_OnExitTrigger_0)) return; 
   }
   
   void Relay_WhileInsideTrigger_0()
   {
      if (true == CheckDebugBreak("b0aa0ab4-b541-4b7b-8964-a20a0c4b31de", "Trigger Events", Relay_WhileInsideTrigger_0)) return; 
   }
   ...
   void Relay_In_1()
   {
      ...
      {
         if (true == CheckDebugBreak("4780ae9d-31f4-4e2f-9e76-68b8486b9ee0", "Teleport", Relay_In_1)) return; 
         {
            {
            ...
            }
            {
               ...
               logic_uScriptAct_Teleport_Destination_1 = local_3_UnityEngine_GameObject;
               
            }
            {
            }
         }
         logic_uScriptAct_Teleport_uScriptAct_Teleport_1.In(logic_uScriptAct_Teleport_Target_1, logic_uScriptAct_Teleport_Destination_1, logic_uScriptAct_Teleport_UpdateRotation_1);
         
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_Teleport_uScriptAct_Teleport_1.Out;
   ...
   void Relay_Finished_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("107f42dc-0bb6-43bb-9471-9d364183d2b6", "Move To Location", Relay_Finished_4)) return; 
      }
      else
      {
   ...
   void Relay_In_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("107f42dc-0bb6-43bb-9471-9d364183d2b6", "Move To Location", Relay_In_4)) return; 
         {
            {
               List<UnityEngine.GameObject> properties = new List<UnityEngine.GameObject>();
               {
            ...
            {
               logic_uScriptAct_MoveToLocation_location_4 = local_8_UnityEngine_Vector3;
   ...
   void Relay_Cancel_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("107f42dc-0bb6-43bb-9471-9d364183d2b6", "Move To Location", Relay_Cancel_4)) return; 
         {
            {
               List<UnityEngine.GameObject> properties = new List<UnityEngine.GameObject>();
               {
   ...
   void Relay_In_5()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("ecc1bb87-4d86-499a-83f5-2ec0f8573f24", "Get Position and Rotation", Relay_In_5)) return; 
         {
            {
               {
                  //if our game object reference was changed then we need to reset event listeners
               ...
               logic_uScriptAct_GetPositionAndRotation_Target_5 = local_7_UnityEngine_GameObject;
         ...
         logic_uScriptAct_GetPositionAndRotation_uScriptAct_GetPositionAndRotation_5.In(logic_uScriptAct_GetPositionAndRotation_Target_5, logic_uScriptAct_GetPositionAndRotation_GetLocal_5, out logic_uScriptAct_GetPositionAndRotation_Position_5, out logic_uScriptAct_GetPositionAndRotation_Rotation_5, out logic_uScriptAct_GetPositionAndRotation_EulerAngles_5, out logic_uScriptAct_GetPositionAndRotation_Forward_5, out logic_uScriptAct_GetPositionAndRotation_Up_5, out logic_uScriptAct_GetPositionAndRotation_Right_5);
         local_8_UnityEngine_Vector3 = logic_uScriptAct_GetPositionAndRotation_Position_5;
         
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GetPositionAndRotation_uScriptAct_GetPositionAndRotation_5.Out;
   ...
   {
      if (true == CheckDebugBreak("86791c12-a06f-4221-bfa8-cd3e7e1fc5bb", "uScript Events", Relay_uScriptStart_6)) return; 
      Relay_In_5();
   }
   ...
   private void UpdateEditorValues( )
   {
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "5c4e3242-fbe5-4f75-8f44-2f0ef1a4c888", local_2_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "TeleportCube_TeleportGraph.uscript:3", local_3_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "06db380b-6438-42f9-9fa7-637e8e170a69", local_3_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "TeleportCube_TeleportGraph.uscript:7", local_7_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "ebb7cde2-728b-4c0f-a454-47a83b0b339b", local_7_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "TeleportCube_TeleportGraph.uscript:8", local_8_UnityEngine_Vector3);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "2988dd27-0a89-463f-9099-4f680d2c8fce", local_8_UnityEngine_Vector3);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "TeleportCube_TeleportGraph.uscript:9", local_9_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "5d3893ea-b3c6-4a77-8338-ceb1938502e1", local_9_UnityEngine_GameObject);
   }
