...
public class AlarmGameplay_MainGame : uScriptLogic
{
   ...
   //local nodes
   System.String local_28_System_String = "Console hacked.";
   UnityEngine.AudioClip local_Alarm_Audio_UnityEngine_AudioClip = null;
   System.Boolean local_Alarm_Hacked__System_Boolean = (bool) false;
   System.Boolean local_Can_Hack__System_Boolean = (bool) true;
   UnityEngine.AudioClip local_Hack_Audio_UnityEngine_AudioClip = null;
   System.String local_Hack_String_System_String = "Press 'H' to hack the console.";
   UnityEngine.Material local_Open_MAT_UnityEngine_Material = null;
   ...
   UnityEngine.AudioClip logic_uScriptAct_PlaySound_audioClip_0 = null;
   ...
   UnityEngine.Material logic_uScriptAct_AssignMaterial_materialName_1 = null;
   ...
   UnityEngine.Material logic_uScriptAct_AssignMaterial_materialName_2 = null;
   ...
   System.String logic_uScriptAct_LoadAudioClip_name_15 = "Audio/alarm";
   UnityEngine.AudioClip logic_uScriptAct_LoadAudioClip_audioClip_15;
   bool logic_uScriptAct_LoadAudioClip_Out_15 = true;
   //pointer to script instanced logic node
   uScriptAct_LoadMaterial logic_uScriptAct_LoadMaterial_uScriptAct_LoadMaterial_16 = new uScriptAct_LoadMaterial( );
   System.String logic_uScriptAct_LoadMaterial_name_16 = "Materials/OpenMAT";
   UnityEngine.Material logic_uScriptAct_LoadMaterial_materialFile_16;
   bool logic_uScriptAct_LoadMaterial_Out_16 = true;
   //pointer to script instanced logic node
   uScriptAct_LoadAudioClip logic_uScriptAct_LoadAudioClip_uScriptAct_LoadAudioClip_17 = new uScriptAct_LoadAudioClip( );
   System.String logic_uScriptAct_LoadAudioClip_name_17 = "Audio/hack_shutdown";
   UnityEngine.AudioClip logic_uScriptAct_LoadAudioClip_audioClip_17;
   bool logic_uScriptAct_LoadAudioClip_Out_17 = true;
   //pointer to script instanced logic node
   uScriptAct_PrintText logic_uScriptAct_PrintText_uScriptAct_PrintText_24 = new uScriptAct_PrintText( );
   System.String logic_uScriptAct_PrintText_Text_24 = "";
   System.Int32 logic_uScriptAct_PrintText_FontSize_24 = (int) 24;
   UnityEngine.FontStyle logic_uScriptAct_PrintText_FontStyle_24 = UnityEngine.FontStyle.Bold;
   UnityEngine.Color logic_uScriptAct_PrintText_FontColor_24 = new UnityEngine.Color( (float)1, (float)0.7762238, (float)0, (float)1 );
   UnityEngine.TextAnchor logic_uScriptAct_PrintText_textAnchor_24 = UnityEngine.TextAnchor.MiddleCenter;
   System.Int32 logic_uScriptAct_PrintText_EdgePadding_24 = (int) 8;
   System.Single logic_uScriptAct_PrintText_time_24 = (float) 0;
   bool logic_uScriptAct_PrintText_Out_24 = true;
   //pointer to script instanced logic node
   uScriptCon_CompareBool logic_uScriptCon_CompareBool_uScriptCon_CompareBool_25 = new uScriptCon_CompareBool( );
   System.Boolean logic_uScriptCon_CompareBool_Bool_25 = (bool) false;
   bool logic_uScriptCon_CompareBool_True_25 = true;
   bool logic_uScriptCon_CompareBool_False_25 = true;
   //pointer to script instanced logic node
   uScriptAct_SetString logic_uScriptAct_SetString_uScriptAct_SetString_27 = new uScriptAct_SetString( );
   System.String logic_uScriptAct_SetString_Value_27 = "";
   ...
   //pointer to script instanced logic node
   AlarmGameplay_AlarmSetup logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37 = new AlarmGameplay_AlarmSetup( );
   UnityEngine.AudioClip logic_AlarmGameplay_AlarmSetup_Alarm_Sound_37 = null;
   System.Boolean logic_AlarmGameplay_AlarmSetup_Alarm_Hacked__37 = (bool) false;
   
   //event nodes
   UnityEngine.GameObject event_UnityEngine_GameObject_Instance_8 = null;
   ...
   System.Int32 event_UnityEngine_GameObject_TimesToTrigger_12 = (int) 0;
   UnityEngine.GameObject event_UnityEngine_GameObject_GameObject_12 = null;
   UnityEngine.GameObject event_UnityEngine_GameObject_Instance_12 = null;
   ...
   UnityEngine.GameObject property_color_Detox_ScriptEditor_Parameter_Instance_11 = null;
   ...
   {
      UnityEngine.Light component = property_color_Detox_ScriptEditor_Parameter_Instance_11.GetComponent<UnityEngine.Light>();
      if ( null != component )
      {
   ...
   void SyncUnityHooks( )
   {
      ...
      {
         property_color_Detox_ScriptEditor_Parameter_Instance_11 = GameObject.Find( "Door_PointLight" ) as UnityEngine.GameObject;
      }
   ...
   void SyncEventListeners( )
   {
      ...
      {
         event_UnityEngine_GameObject_Instance_10 = GameObject.Find( "Trigger_Console" ) as UnityEngine.GameObject;
         if ( null != event_UnityEngine_GameObject_Instance_10 )
         {
            {
               uScript_Triggers component = event_UnityEngine_GameObject_Instance_10.GetComponent<uScript_Triggers>();
               if ( null == component )
               {
                  component = event_UnityEngine_GameObject_Instance_10.AddComponent<uScript_Triggers>();
               }
               if ( null != component )
               {
      ...
      {
         event_UnityEngine_GameObject_Instance_12 = GameObject.Find( "Trigger_Alarm" ) as UnityEngine.GameObject;
         if ( null != event_UnityEngine_GameObject_Instance_12 )
         {
            {
               uScript_Triggers component = event_UnityEngine_GameObject_Instance_12.GetComponent<uScript_Triggers>();
               if ( null == component )
               {
                  component = event_UnityEngine_GameObject_Instance_12.AddComponent<uScript_Triggers>();
               }
               if ( null != component )
               {
                  component.TimesToTrigger = event_UnityEngine_GameObject_TimesToTrigger_12;
               }
            }
            {
               uScript_Triggers component = event_UnityEngine_GameObject_Instance_12.GetComponent<uScript_Triggers>();
   ...
   public override void SetParent(GameObject g)
   {
      ...
      logic_uScriptAct_LoadMaterial_uScriptAct_LoadMaterial_16.SetParent(g);
      logic_uScriptAct_LoadAudioClip_uScriptAct_LoadAudioClip_17.SetParent(g);
      ...
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.SetParent(g);
   }
   public void Awake()
   {
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.Awake( );
   ...
   public void Start()
   {
      ...
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.Start( );
   }
   ...
   public void OnEnable()
   {
      ...
      m_RegisteredForEvents = true;
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.OnEnable( );
   }
   
   public void OnDisable()
   {
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.OnDisable( );
   ...
   public void Update()
   {
      ...
      logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.Update( );
   }
   ...
   void Instance_OnEnterTrigger_12(object o, uScript_Triggers.TriggerEventArgs e)
   {
      //reset event call
      //if it ever goes above MaxRelayCallCount before being reset
      //then we assume it is stuck in an infinite loop
   ...
   void Instance_OnExitTrigger_12(object o, uScript_Triggers.TriggerEventArgs e)
   {
      //reset event call
      //if it ever goes above MaxRelayCallCount before being reset
      //then we assume it is stuck in an infinite loop
   ...
   void Instance_WhileInsideTrigger_12(object o, uScript_Triggers.TriggerEventArgs e)
   {
      //reset event call
      //if it ever goes above MaxRelayCallCount before being reset
      //then we assume it is stuck in an infinite loop
   ...
   void AlarmGameplay_AlarmSetup_Out___Alarm_Start_37(object o, AlarmGameplay_AlarmSetup.LogicEventArgs e)
   {
      //fill globals
      //relay event to nodes
      Relay_Out___Alarm_Start_37( );
   }
   
   void AlarmGameplay_AlarmSetup_Out___Alarm_Stop_37(object o, AlarmGameplay_AlarmSetup.LogicEventArgs e)
   {
      //fill globals
      //relay event to nodes
      Relay_Out___Alarm_Stop_37( );
   }
   ...
   void Relay_Finished_0()
   {
      ...
      {
         if (true == CheckDebugBreak("70c291c7-79e6-48cc-9084-eac106f8a1ab", "Play Sound", Relay_Finished_0)) return; 
      }
      else
      {
   ...
   void Relay_Play_0()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("70c291c7-79e6-48cc-9084-eac106f8a1ab", "Play Sound", Relay_Play_0)) return; 
         {
            {
   ...
   void Relay_UpdateVolume_0()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("70c291c7-79e6-48cc-9084-eac106f8a1ab", "Play Sound", Relay_UpdateVolume_0)) return; 
         {
            {
               logic_uScriptAct_PlaySound_audioClip_0 = local_Hack_Audio_UnityEngine_AudioClip;
   ...
   void Relay_Stop_0()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("70c291c7-79e6-48cc-9084-eac106f8a1ab", "Play Sound", Relay_Stop_0)) return; 
         {
            {
               logic_uScriptAct_PlaySound_audioClip_0 = local_Hack_Audio_UnityEngine_AudioClip;
   ...
   void Relay_In_1()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("95447226-5a63-49d4-a20a-9574816371ba", "Assign Material", Relay_In_1)) return; 
         {
            {
            }
            {
   ...
   void Relay_In_2()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("722c036f-bfd3-47da-8ea4-1b4f2c62b02c", "Assign Material", Relay_In_2)) return; 
         {
            {
            }
            {
   ...
   void Relay_True_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("a72c7648-3ae3-4971-a097-272b3511d09b", "Set Bool", Relay_True_4)) return; 
         {
            {
            }
         }
   ...
   void Relay_False_4()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("a72c7648-3ae3-4971-a097-272b3511d09b", "Set Bool", Relay_False_4)) return; 
         {
            {
            }
         }
   ...
   void Relay_In_6()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("4499df27-2966-473e-865e-f6ed8840bedd", "Compare Bool", Relay_In_6)) return; 
         {
            {
   ...
   {
      if (true == CheckDebugBreak("7624d46c-7a48-4c2b-b873-7e750c7a71fa", "Input Events", Relay_KeyEvent_8)) return; 
      Relay_In_13();
   }
   ...
   void Relay_In_9()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("ea2bed66-7a23-4f83-9413-f8580d9fba4d", "Set Color", Relay_In_9)) return; 
         {
            {
            }
            {
         ...
         property_color_Detox_ScriptEditor_Parameter_color_11 = logic_uScriptAct_SetColor_TargetColor_9;
   ...
   {
      if (true == CheckDebugBreak("3bd379a7-4f2f-4f2c-bbbf-76fd5b91ae56", "Trigger Events", Relay_OnEnterTrigger_10)) return; 
   }
   
   void Relay_OnExitTrigger_10()
   {
      if (true == CheckDebugBreak("3bd379a7-4f2f-4f2c-bbbf-76fd5b91ae56", "Trigger Events", Relay_OnExitTrigger_10)) return; 
      Relay_HideLabel_24();
   }
   
   void Relay_WhileInsideTrigger_10()
   {
      if (true == CheckDebugBreak("3bd379a7-4f2f-4f2c-bbbf-76fd5b91ae56", "Trigger Events", Relay_WhileInsideTrigger_10)) return; 
      Relay_ShowLabel_24();
   }
   
   void Relay_OnEnterTrigger_12()
   {
      if (true == CheckDebugBreak("5882b994-3899-4274-ba09-0338590fa395", "Trigger Events", Relay_OnEnterTrigger_12)) return; 
      Relay_Alarm_Start_37();
   }
   
   void Relay_OnExitTrigger_12()
   {
      if (true == CheckDebugBreak("5882b994-3899-4274-ba09-0338590fa395", "Trigger Events", Relay_OnExitTrigger_12)) return; 
      Relay_Alarm_Stop_37();
   }
   
   void Relay_WhileInsideTrigger_12()
   {
      if (true == CheckDebugBreak("5882b994-3899-4274-ba09-0338590fa395", "Trigger Events", Relay_WhileInsideTrigger_12)) return; 
   }
   ...
   void Relay_In_13()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("812b5fc5-f40f-4bff-9242-b0de30fd465c", "Input Events Filter", Relay_In_13)) return; 
         {
            {
            }
         }
         ...
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_13.KeyUp;
   ...
   {
      if (true == CheckDebugBreak("88a985e9-4f2c-4a56-982b-5f2e5a409425", "uScript Events", Relay_uScriptStart_14)) return; 
      Relay_In_15();
   }
   
   void Relay_uScriptLateStart_14()
   {
      if (true == CheckDebugBreak("88a985e9-4f2c-4a56-982b-5f2e5a409425", "uScript Events", Relay_uScriptLateStart_14)) return; 
   }
   ...
   void Relay_In_15()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("889a18c0-0cfd-4611-8f36-b6eccaeb1fc8", "Load AudioClip", Relay_In_15)) return; 
         {
            {
            }
            {
         ...
         local_Alarm_Audio_UnityEngine_AudioClip = logic_uScriptAct_LoadAudioClip_audioClip_15;
   ...
   void Relay_In_16()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("257957cc-4313-4f02-abfe-aa8fc0f2d3da", "Load Material", Relay_In_16)) return; 
         {
            {
            }
            {
         ...
         logic_uScriptAct_LoadMaterial_uScriptAct_LoadMaterial_16.In(logic_uScriptAct_LoadMaterial_name_16, out logic_uScriptAct_LoadMaterial_materialFile_16);
         local_Open_MAT_UnityEngine_Material = logic_uScriptAct_LoadMaterial_materialFile_16;
   ...
   void Relay_In_17()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("e14b563b-f0fa-40d2-9bac-e2916214cc46", "Load AudioClip", Relay_In_17)) return; 
         {
            {
            }
            {
         ...
         logic_uScriptAct_LoadAudioClip_uScriptAct_LoadAudioClip_17.In(logic_uScriptAct_LoadAudioClip_name_17, out logic_uScriptAct_LoadAudioClip_audioClip_17);
         local_Hack_Audio_UnityEngine_AudioClip = logic_uScriptAct_LoadAudioClip_audioClip_17;
         
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_LoadAudioClip_uScriptAct_LoadAudioClip_17.Out;
   ...
   void Relay_ShowLabel_24()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("b2bb5a05-e7c7-4dd6-9777-9371626bd5a2", "Print Text", Relay_ShowLabel_24)) return; 
         {
            {
               logic_uScriptAct_PrintText_Text_24 = local_Hack_String_System_String;
   ...
   void Relay_HideLabel_24()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("b2bb5a05-e7c7-4dd6-9777-9371626bd5a2", "Print Text", Relay_HideLabel_24)) return; 
         {
            {
               logic_uScriptAct_PrintText_Text_24 = local_Hack_String_System_String;
   ...
   void Relay_In_25()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("d9a7b4fd-804d-465e-94af-6cb3b07b3643", "Compare Bool", Relay_In_25)) return; 
         {
            {
               logic_uScriptCon_CompareBool_Bool_25 = local_Alarm_Hacked__System_Boolean;
         ...
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptCon_CompareBool_uScriptCon_CompareBool_25.False;
   ...
   void Relay_In_27()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("a3593eed-ad64-4f12-b30b-66b77dd5d636", "Set String", Relay_In_27)) return; 
         {
            {
               logic_uScriptAct_SetString_Value_27 = local_28_System_String;
         ...
         local_Hack_String_System_String = logic_uScriptAct_SetString_Target_27;
   ...
   void Relay_Out___Alarm_Start_37()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("8fdf5393-0564-4d28-9e78-aa3a4f827e37", "Alarm Setup", Relay_Out___Alarm_Start_37)) return; 
      }
      else
      {
   ...
   void Relay_Out___Alarm_Stop_37()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("8fdf5393-0564-4d28-9e78-aa3a4f827e37", "Alarm Setup", Relay_Out___Alarm_Stop_37)) return; 
      }
      else
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript AlarmGameplay_MainGame.uscript at Alarm Setup.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
   ...
   void Relay_Alarm_Start_37()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("8fdf5393-0564-4d28-9e78-aa3a4f827e37", "Alarm Setup", Relay_Alarm_Start_37)) return; 
         {
            {
               logic_AlarmGameplay_AlarmSetup_Alarm_Sound_37 = local_Alarm_Audio_UnityEngine_AudioClip;
               
            }
            {
               logic_AlarmGameplay_AlarmSetup_Alarm_Hacked__37 = local_Alarm_Hacked__System_Boolean;
               
            }
         }
         logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.Alarm_Start(logic_AlarmGameplay_AlarmSetup_Alarm_Sound_37, logic_AlarmGameplay_AlarmSetup_Alarm_Hacked__37);
   ...
   void Relay_Alarm_Stop_37()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("8fdf5393-0564-4d28-9e78-aa3a4f827e37", "Alarm Setup", Relay_Alarm_Stop_37)) return; 
         {
            {
               logic_AlarmGameplay_AlarmSetup_Alarm_Sound_37 = local_Alarm_Audio_UnityEngine_AudioClip;
         ...
         logic_AlarmGameplay_AlarmSetup_AlarmGameplay_AlarmSetup_37.Alarm_Stop(logic_AlarmGameplay_AlarmSetup_Alarm_Sound_37, logic_AlarmGameplay_AlarmSetup_Alarm_Hacked__37);
   ...
   private void UpdateEditorValues( )
   {
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "AlarmGameplay_MainGame.uscript:28", local_28_System_String);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "8240847b-bc3f-4eb1-a58c-94736df4bece", local_28_System_String);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "13d5ac84-faf7-4ad3-9e0b-fdfdf1c7f201", property_color_Detox_ScriptEditor_Parameter_color_11);
   }
