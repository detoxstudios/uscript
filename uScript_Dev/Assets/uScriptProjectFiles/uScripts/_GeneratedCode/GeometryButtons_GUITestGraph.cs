...
public class GeometryButtons_GUITestGraph : uScriptLogic
{
   ...
   UnityEngine.Camera local_16_UnityEngine_Camera = default(UnityEngine.Camera);
   ...
   UnityEngine.GameObject logic_uScriptCon_CompareGameObjects_A_3 = default(UnityEngine.GameObject);
   UnityEngine.GameObject logic_uScriptCon_CompareGameObjects_B_3 = default(UnityEngine.GameObject);
   ...
   UnityEngine.Camera logic_uScriptAct_RaycastFromScreenPoint_Camera_12 = default(UnityEngine.Camera);
   ...
   UnityEngine.GameObject logic_uScriptAct_IsometricCharacterController_target_18 = default(UnityEngine.GameObject);
   System.Single logic_uScriptAct_IsometricCharacterController_translation_18 = (float) 5;
   System.Single logic_uScriptAct_IsometricCharacterController_rotation_18 = (float) 85;
         ...
         {
            {
               ...
               if ( null != component )
               {
                  ...
                  component.uScriptLateStart += Instance_uScriptLateStart_7;
               }
            }
         }
      }
   ...
   void Instance_uScriptLateStart_7(object o, System.EventArgs e)
   {
      //reset event call
      //if it ever goes above MaxRelayCallCount before being reset
      //then we assume it is stuck in an infinite loop
