...
public class uScript_TestBed : uScriptLogic
{
   ...
   System.Object[] logic_uScriptAct_Log_Target_0 = new System.Object[] {"Down"};
   System.String logic_uScriptAct_Log_Postfix_0 = "";
   bool logic_uScriptAct_Log_Out_0 = true;
   //pointer to script instanced logic node
   uScriptAct_OnInputEventFilter logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1 = null;
   UnityEngine.KeyCode logic_uScriptAct_OnInputEventFilter_KeyCode_1 = UnityEngine.KeyCode.A;
   ...
   public void Awake()
   {
      ...
      logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1 = ScriptableObject.CreateInstance(typeof(uScriptAct_OnInputEventFilter)) as uScriptAct_OnInputEventFilter;
   ...
   public override void Update()
   {
      ...
      logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.Update( );
   ...
   public override void LateUpdate()
   {
      ...
      logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.LateUpdate( );
   ...
   public override void FixedUpdate()
   {
      ...
      logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.FixedUpdate( );
   ...
   public override void OnGUI()
   {
      ...
      logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.OnGUI( );
   ...
   void Relay_In_1()
   {
      ...
      SyncUnityHooks( );
      if ( logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.KeyHeld == true )
      {
      }
      if ( logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.KeyDown == true )
      {
         Relay_In_0();
      }
      if ( logic_uScriptAct_OnInputEventFilter_uScriptAct_OnInputEventFilter_1.KeyUp == true )
      {
         Relay_In_2();
      }
   }
