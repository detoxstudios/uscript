...
public class uScript_TestBed : uScriptLogic
{
   ...
   uScriptAct_OnKeyPressFilter logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0 = null;
   UnityEngine.KeyCode logic_uScriptAct_OnKeyPressFilter_KeyCode_0 = UnityEngine.KeyCode.A;
   bool logic_uScriptAct_OnKeyPressFilter_KeyHeld_0 = true;
   bool logic_uScriptAct_OnKeyPressFilter_KeyDown_0 = true;
   bool logic_uScriptAct_OnKeyPressFilter_KeyUp_0 = true;
   //pointer to script instanced logic node
   ...
   System.Object[] logic_uScriptAct_Log_Target_2 = new System.Object[] {"Down"};
   ...
   public override void SetParent(GameObject g)
   {
      ...
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.SetParent(g);
   ...
   public void Awake()
   {
      ...
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0 = ScriptableObject.CreateInstance(typeof(uScriptAct_OnKeyPressFilter)) as uScriptAct_OnKeyPressFilter;
   ...
   {
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.Update( );
      logic_uScriptAct_Log_uScriptAct_Log_1.Update( );
      logic_uScriptAct_Log_uScriptAct_Log_2.Update( );
   }
   
   public override void LateUpdate()
   {
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.LateUpdate( );
      logic_uScriptAct_Log_uScriptAct_Log_1.LateUpdate( );
      logic_uScriptAct_Log_uScriptAct_Log_2.LateUpdate( );
   }
   
   public override void FixedUpdate()
   {
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.FixedUpdate( );
      logic_uScriptAct_Log_uScriptAct_Log_1.FixedUpdate( );
      logic_uScriptAct_Log_uScriptAct_Log_2.FixedUpdate( );
   }
   
   public override void OnGUI()
   {
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.OnGUI( );
      logic_uScriptAct_Log_uScriptAct_Log_1.OnGUI( );
   ...
   void Relay_In_0()
   {
      ...
      logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.In(logic_uScriptAct_OnKeyPressFilter_KeyCode_0);
      SyncUnityHooks( );
      if ( logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.KeyHeld == true )
      {
      }
      if ( logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.KeyDown == true )
      {
         Relay_In_2();
      }
      if ( logic_uScriptAct_OnKeyPressFilter_uScriptAct_OnKeyPressFilter_0.KeyUp == true )
      {
         Relay_In_1();
      }
   }
