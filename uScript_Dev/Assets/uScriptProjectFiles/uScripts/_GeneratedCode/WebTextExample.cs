...
public class WebTextExample : uScriptLogic
{
   ...
   void Relay_In_17()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_17.Changed;
         bool test_1 = logic_uScriptAct_GUIToggle_uScriptAct_GUIToggle_17.Out;
   ...
   void Relay_In_18()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GUITextField_uScriptAct_GUITextField_18.Changed;
         bool test_1 = logic_uScriptAct_GUITextField_uScriptAct_GUITextField_18.Out;
   ...
   void Relay_In_31()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         logic_uScriptAct_ConvertVariable_uScriptAct_ConvertVariable_31.In(logic_uScriptAct_ConvertVariable_Target_31, out logic_uScriptAct_ConvertVariable_IntValue_31, out logic_uScriptAct_ConvertVariable_FloatValue_31, out logic_uScriptAct_ConvertVariable_StringValue_31, out logic_uScriptAct_ConvertVariable_BooleanValue_31, out logic_uScriptAct_ConvertVariable_Vector3Value_31);
   ...
   void Relay_In_34()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         //save off values because, if there are multiple, our relay logic could cause them to change before the next value is tested
         bool test_0 = logic_uScriptAct_GUISelectionGrid_uScriptAct_GUISelectionGrid_34.Changed;
         bool test_1 = logic_uScriptAct_GUISelectionGrid_uScriptAct_GUISelectionGrid_34.Out;
